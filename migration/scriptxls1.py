...
s3_key = '/ichtegem/Weather+Underground+-+Ichtegem,+BE.xlsx'
file_path = '/tmp/Weather+Underground+-+Ichtegem,+BE.xlsx'
...
for sheet_name in xls.sheet_names:
    ...
    df["id_station"] = "IICHTE19"
    df["station_name"] = "WeerstationBS"
    df["latitude"] = 51.092
    df["longitude"] = 2.999
    df["elevation"] = 15
    df["name"] = "Ichtegem"
